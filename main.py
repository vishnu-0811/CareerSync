      ...
      <div class="pg-home-hero-grid">
        <div class="pg-home-hero-content">
          ...
          <div class="pg-home-hero-actions">
            <a class="pg-btn pg-btn-primary pg-home-hero-cta" href="/1_Resume_Classifier">
              Analyze Resume
    ...
    <section class="pg-home-explore" aria-labelledby="home-explore-title">
      ...
      <div class="pg-home-explore-grid">
        <article class="pg-home-explore-card">
          ...
          <a class="pg-home-explore-cta" href="/1_Resume_Classifier">
        ...
        <article class="pg-home-explore-card">
          ...
          <a class="pg-home-explore-cta" href="/2_Job_Fit_Analyzer">
        ...
        <article class="pg-home-explore-card">
          ...
          <a class="pg-home-explore-cta" href="/4_Dashboard">
